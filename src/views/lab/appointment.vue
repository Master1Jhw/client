<template>
  <div class="app-container">
   <div>
    ...
    <span>实验室id:{{labInfo.labId}}</span>
     ...
     <el-divider></el-divider>
     <span>
       申请人数&nbsp;&nbsp;&nbsp;<el-input-number v-model="AppointInfo.count = 30" @change="handleChange"  label="申请人数(最多30人)" disabled ></el-input-number>
     </span>
     <!-- <span>
        申请设备
     ...
     -->
      ...
      实验内容
      <br><br>
      <el-select v-model ="AppointInfo.description" placeholder="请选择课程">
      <el-option
 ...
 <br><br>预约日期(点击右侧按钮查看实验室预约详情)
       <router-link :to="'/lab/details/' + this.id">
          <el-tooltip class="item" effect="dark" content="点击查看实验室使用时间详情" placement="right">(点击右侧按钮查看实验室预约详情)
