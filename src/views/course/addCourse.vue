  ...
  <div class="app-container">
    <el-form ref="form" :model="sizeForm" label-width="80px" size="mini">
      ...
      <el-form-item label="实验室id">
        <el-input placeholder="请输入实验室id（仅用于信息展示，具体以预约时间为准）" style="width: 200px"
                  v-model="sizeForm.lid"></el-input>
      </el-form-item>
      <el-form-item label="实验室名称">
        <el-input placeholder="请输入实验室名称（仅用于信息展示，具体以预约时间为准）" style="width: 500px"
                  v-model="sizeForm.lname"></el-input>
      </el-form-item>
      <el-form-item label="开课日期">
        <el-input placeholder="第x周-第y周（仅用于信息展示，具体以预约时间为准）" style="width: 800px" type="textarea" :autosize="{ minRows: 2, maxRows: 4}"
