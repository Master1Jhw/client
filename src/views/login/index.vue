  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
      ...
      <div style="text-align: center">
        <el-radio v-model="loginForm.role" label="teacher" value="teacher">教师   </el-radio>
    ...
    <div align="center"><font color="red">教师账号：2024密码：123456</font></div>
    <div align="center"><font color="red">管理员账号：admin密码：123456</font></div>
  </div>
</template>
