...
export const asyncRoutes = [
  ...
  },
  {
    ...
    name: '设备管理',
    meta: {title: '设备管理', icon: 'example', roles: ['user'] },
    children: [{
  ...
  },
  {
    ...
    children: [{
      ...
      meta: { title: '实验室预约', noCache: true, roles: ['admin', 'user', 'teacher'] },
      hidden: true
    },
    ...
    },
    {
      ...
      meta: { title: '预约审核', icon: 'table', roles: ['admin'] }
    },
    {
      path: 'old',
      name: '已审核信息',
...

  {
    ...
    name: '公告',
    alwaysShow: true,
    meta: {title: '公告', icon: 'example',roles: ['user'] },
    children: [{
  ...
  },
  {
    ...
    name: '耗材',
    alwaysShow: true,
    meta: {title: '实验室耗材管理', icon:'example',roles: ['user']},
    children: [{
